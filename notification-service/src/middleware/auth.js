/**
 * Autenticación del notification-service.
 * Verifica el JWT compartido (para que el usuario lea SOLO sus avisos) y
 * `requireInternal` para el envío máquina-a-máquina desde otros servicios.
 */
