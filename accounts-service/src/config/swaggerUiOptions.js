 ...
 * Se aplica en /api-docs. Solo estilos: no altera la especificación.
 */
const customCss = `
  .swagger-ui .topbar { background: linear-gradient(90deg,#0b1437,#1b2a6b); border-bottom: 2px solid #4f8cff; }
  .swagger-ui .topbar .download-url-wrapper { display:none; }
  .swagger-ui .topbar-wrapper::after {
    content: '💸 NeoWallet API'; color:#eaf0ff; font-weight:800; font-size:18px; margin-left:12px; letter-spacing:.5px;
  }
  ...
  .swagger-ui .opblock.opblock-post { background:rgba(73,204,144,.08); border-color:#49cc90; }
  .swagger-ui .btn.execute { background:#4f8cff; border-color:#4f8cff; }
`

const options = {
  customCss,
  customSiteTitle: 'NeoWallet API · Docs',
