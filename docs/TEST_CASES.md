...
| TC-010 | Rechazar fecha pasada | Usuario autenticado | 1. Enviar reserva para fecha anterior a la actual. | Respuesta 400 con mensaje claro indicando que la fecha no puede estar en el pasado. | Media |
