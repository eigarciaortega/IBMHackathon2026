    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/spaces").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.PUT, "/spaces/**").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.DELETE, "/spaces/**").hasRole("ADMINISTRADOR")
