 ...
 */
const customCss = `
  .swagger-ui .topbar { background: linear-gradient(90deg,#0b1437,#1b2a6b); border-bottom: 2px solid #49cc90; }
  .swagger-ui .topbar .download-url-wrapper { display:none; }
  .swagger-ui .topbar-wrapper::after {
    content: '🔁 NeoWallet · Processor'; color:#eaf0ff; font-weight:800; font-size:18px; margin-left:12px; letter-spacing:.5px;
  }
  ...
  .swagger-ui .btn.execute { background:#49cc90; border-color:#49cc90; }
`

const options = {
  customCss,
  customSiteTitle: 'NeoWallet Processor · Docs',
